...
export default function DeleteCatalogDialog({ itemName, onCancel, onDelete }) {
  return (
    <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl w-full max-w-sm p-8 text-center">
        ...
        <h2 className="text-lg font-bold text-gray-900 mb-2">DELETE {itemName?.toUpperCase()}?</h2>
        <p className="text-sm text-gray-500 mb-6">
          Once deleted, this product is gone from<br />your catalog 👋
        </p>
